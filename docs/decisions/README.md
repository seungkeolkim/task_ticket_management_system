...
| 파일 | ID 접두사 | 범위 | 다음 ID |
|---|---|---|---|
| [architecture-and-configuration.md](architecture-and-configuration.md) | `ARC` | 기술 구조, 실행 환경, 외부 설정 | `ARC-011` |
| [users-auth-and-permissions.md](users-auth-and-permissions.md) | `IAM` | 사용자, 인증, 세션, 역할, 권한 | `IAM-014` |
| [organizations-and-projects.md](organizations-and-projects.md) | `ORG`, `PRJ` | 조직 계층, 프로젝트, 구성원 격리 | `ORG-004`, `PRJ-004` |
...
| [database-and-data-lifecycle.md](database-and-data-lifecycle.md) | `DB` | DB 타입, migration, transaction, 보존 | `DB-014` |
| [ui-search-and-notifications.md](ui-search-and-notifications.md) | `UI` | 화면, 목록, 검색, 칸반, 알림 범위 | `UI-010` |
